              ...
              {salesReturns.length === 0 ? (
                ...
                salesReturns.map((ret) => (
                  <tr key={ret.id} className="border-b hover:bg-muted/50">
                    ...
                    <td className="py-3 px-2 sm:px-4 font-semibold text-red-600 text-sm">₹{ret.totalRefund}</td>
                  </tr>
                ))
              )}
            </tbody>
              ...
              {purchaseReturns.length === 0 ? (
                ...
                purchaseReturns.map((ret) => (
                  <tr key={ret.id} className="border-b hover:bg-muted/50">
                    ...
                    <td className="py-3 px-2 sm:px-4 font-semibold text-green-600 text-sm">₹{ret.amountAdjusted}</td>
                  </tr>
                ))
              )}
            </tbody>
